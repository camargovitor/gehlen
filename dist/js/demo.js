...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      + "Barra lateral Expandir ou Flutuar"
      + "</label>"
      + "<p>Deixe a mini barra lateral expandir ou flutuar</p>"
      + "</div>"
      ...
      + "Alternar a cor da barra lateral direita"
      + "</label>"
      + "<p>Alternar entre cores escuras e claras para a barra lateral direita</p>"
      + "</div>"
  );
